	        ...
	        out.println("<body>");
	        		...
	        		out.println("<div class='container-fluid'>");
	        			...
	        			out.println("<ul class='nav navbar-nav'>");
	        				...
	        				out.println("<li class='dropdown'><a class='dropdown-toggle' data-toggle='dropdown' href='#'>Task<span class='caret'></span></a>");
		        				...
		        				out.println("</ul>");
	        				out.println("</li>");
	        				out.println("<li class='active' ><a href='#'>History</a></li>");
	        	...
	        	out.println("<div class='container'>");
	        		out.println("<div class='panel panel-body' align='center'>");
	        			...
	        			out.println("<h1>History of Task</h1>");
        	        	List<History> list = HistoryDao.getAllHistory();
	        			out.print("<table border='1' width='100%'>");  
	        	        	out.print("<tr><th style='text-align:center'>Id</th><th style='text-align:center'>Name</th><th style='text-align:center'>Description</th><th style='text-align:center'>Date</th></tr>");
	        	        	for(History e:list){  
	        	        		 out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getDescription()+"</td><td>"+e.getDate()+"</td></tr>");  
	        	        	}  
	        	        out.print("</table>");
	        			out.println("</div");
	        		out.println("</div");
